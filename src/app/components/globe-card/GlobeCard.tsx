...
const World = dynamic(() => import("../ui/globe").then((m) => m.World), {
  ...
  return (
    <div className="relative w-full h-[30rem] flex flex-col items-center justify-center -mt-14">
      <p className="mb-10 z-20 relative shadow-lg">
      ...
      <p className="z-20 relative shadow-lg">Whether you have a project in mind or just want to say hello, feel free to reach out!</p>
