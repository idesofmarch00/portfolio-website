  ...
  return (
    <>
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <IconX className="h-6 w-6 text-neutral-100 text-neutral-900" />
              </button>
              <motion.p
                layoutId={layout ? `title-${card.title}` : undefined}
                className="text-2xl md:text-5xl -mt-8 font-semibold text-white"
              >
                {card.title}
              </motion.p>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 bg-neutral-900 h-96 w-72 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
