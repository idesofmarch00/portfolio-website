        ...
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            className={cn(
              ...
              pathname === navItem.link ? "text-white bg-gradient-to-r from-blue-500 to-purple-500 text-white border-transparent border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full" : ""
            )}
          >
