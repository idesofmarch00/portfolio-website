        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-black rounded-lg shadow-lg overflow-hidden border border-white">
            <div className="bg-gray-700 px-4 py-2 flex items-center space-x-2 relative">
                          ...
                          <div className="cursor-pointer w-3 h-3 rounded-full bg-yellow-500 flex items-center justify-center" onClick={()=>{router.back()}}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-2 w-2 text-white" viewBox="0 0 20 20" fill="black">
                              <path fillRule="evenodd" d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z" clipRule="evenodd" />
                            </svg>
                          </div>
                          <div className="cursor-pointer w-3 h-3 rounded-full bg-green-500 flex items-center justify-center" onClick={()=>{router.push('https://drive.google.com/file/d/1j4x6xJqSF2KGemqWvj-5M-HEpkZPCQy-/view?usp=drive_link')}}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-2 w-2 text-white" viewBox="0 0 20 20" fill="black">
